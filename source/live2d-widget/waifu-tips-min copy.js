...
! function () {
  ...
  function o(o, s, i) {
    ...
    n.innerHTML = o, n.classList.add("waifu-tips-active"), t = setTimeout((() => {
  ...
  class s {
    ...
    async loadModel(t, s, i) {
      if (localStorage.setItem("modelId", t), localStorage.setItem("modelTexturesId", s), o(i, 4e3, 10), this.useCDN) {
  ...
  const i = {
    hitokoto: {
      icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M160 64c0-11.8-6.5-22.6-16.9-28.2s-23-5-32.8 1.6l-96 64C-.5 111.2-4.4 131 5.4 145.8s29.7 18.7 44.4 8.9L96 123.8V416H32c-17.7 0-32 14.3-32 32s14.3 32 32 32h96 96c17.7 0 32-14.3 32-32s-14.3-32-32-32H160V64z"/></svg>',
      callback: function () {
    ...
    quit: {
      icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/></svg>',
      callback: () => {
        localStorage.setItem("waifu-display", Date.now()), o("愿有一天你能与挚爱之人重逢。", 2e3, 11), document.getElementById("waifu").style.bottom = "-500px", setTimeout((() => {
  ...
  function n(t) {
    ...
    function c(t) {
      ...
      window.addEventListener("mousemove", (() => i = !0)), window.addEventListener("keydown", (() => i = !0)), setInterval((() => {
        ...
        if ("" !== document.referrer) {
          ...
          return location.hostname === e.hostname ? t : (o = s in i ? i[s] : e.hostname, `Hello！来自 <span>${o}</span> 的朋友<br>${t}`)
        }
        return t
        ...
        const s = new Date,
          i = t.split("-")[0],
          c = t.split("-")[1] || i;
        i.split("/")[0] <= s.getMonth() + 1 && s.getMonth() + 1 <= c.split("/")[0] && i.split("/")[1] <= s.getDate() && s.getDate() <= c.split("/")[1] && (o = (o = e(o)).replace("{year}", s.getFullYear()), n.push(o))
    ...
    localStorage.removeItem("waifu-display"), sessionStorage.removeItem("waifu-text"), document.body.insertAdjacentHTML("beforeend", '<div id="waifu">\n            <div id="waifu-tips"></div>\n            <canvas id="live2d" width="200" height="200"></canvas>\n            <div id="waifu-tool"></div>\n        </div>'), setTimeout((() => {
      ...
      function () {
        i["switch-model"].callback = () => n.loadOtherModel(), i["switch-texture"].callback = () => n.loadRandModel(), Array.isArray(t.tools) || (t.tools = Object.keys(i));
      ...
      function () {
        ...
        null === e && (e = 1, o = 53), n.loadModel(e, o), fetch(t.waifuPath).then((e => e.json())).then(c)
      }()
  }
  window.initWidget = function (e, t) {
    ...
    o.addEventListener("click", (() => {
      o.classList.remove("waifu-toggle-active"), o.getAttribute("first-time") ? (n(e), o.removeAttribute("first-time")) : (localStorage.removeItem("waifu-display"), document.getElementById("waifu").style.display = "", setTimeout((() => {
        document.getElementById("waifu").style.bottom = 0
      }), 0))
