!(function (t) {
  ...
  function (t, i, e) {
    ...
    (r.prototype.getModelMatrix = function () {
      ...
      (o.loadJson = function (t) {
        ...
        for (var _ = 0; _ < s; _++) {
          ...
          else if (l == o.TYPE_MULT) {
            var p;
            0 == (p = null == a.def ? 1 : parseFloat(a.def)) && (p = 1),
              ($ /= p);
          }
          var f = new n();
          (f.id = h), (f.type = l), (f.value = $), i.paramList.push(f);
        }
        return i;
      }),
      ...
      (s.prototype.updateParam = function (t) {
        ...
        switch (this.eyeState) {
          case y.STATE_CLOSING:
            (r = (e - this.stateStartTime) / this.closingMotionMsec) >= 1 &&
              ((r = 1),
            ...
            break;
          case y.STATE_CLOSED:
            (r = (e - this.stateStartTime) / this.closedMotionMsec) >= 1 &&
              ((this.eyeState = y.STATE_OPENING), (this.stateStartTime = e)),
              (i = 0);
            break;
          case y.STATE_OPENING:
            (r = (e - this.stateStartTime) / this.openingMotionMsec) >= 1 &&
              ((r = 1),
    ...
    (y.STATE_FIRST = "STATE_FIRST"),
      ...
      ($.load = function (t) {
        for (
          var i = new $(),
            e = c.getPlatformManager().jsonParseFromBytes(t).physics_hair,
            r = e.length,
            o = 0;
          o < r;
          o++
          ...
          for (var u = n.src, p = u.length, f = 0; f < p; f++) {
            ...
            "x" === (v = d.ptype)
              ? (g = PhysicsHair.Src.SRC_TO_X)
              : "y" === v
              ? (g = PhysicsHair.Src.SRC_TO_Y)
              : "angle" === v
              ? (g = PhysicsHair.Src.SRC_TO_G_ANGLE)
              : UtDebug.error("live2d", "Invalid parameter:PhysicsHair.Src");
            var m = parseFloat(d.scale),
              T = parseFloat(d.weight);
            s.addSrcParam(g, y, m, T);
          }
          var P = n.targets,
            S = P.length;
          for (f = 0; f < S; f++) {
            var v,
              L = P[f];
            (y = L.id), (g = PhysicsHair.Target.TARGET_FROM_ANGLE);
            "angle" === (v = L.ptype)
              ? (g = PhysicsHair.Target.TARGET_FROM_ANGLE)
              : "angle_v" === v
              ? (g = PhysicsHair.Target.TARGET_FROM_ANGLE_V)
              : UtDebug.error("live2d", "Invalid parameter:PhysicsHair.Target");
            (m = parseFloat(L.scale)), (T = parseFloat(L.weight));
            s.addTargetParam(g, y, m, T);
          }
      ...
      (l.load = function (t) {
        for (
          var i = new l(),
            e = c.getPlatformManager().jsonParseFromBytes(t).parts_visible,
            r = e.length,
            o = 0;
          o < r;
          o++
        ...
        if (0 != this.lastTimeSec) {
          ...
          if (!(Math.abs(o) <= this.EPSILON && Math.abs(n) <= this.EPSILON)) {
            ...
            ($ < -r || $ > r) && ((a *= r / $), (h *= r / $), ($ = r)),
              (this.faceVX += a),
              (this.faceVY += h);
            var l = 0.5 * (Math.sqrt(r * r + 16 * r * s - 8 * r * s) - r),
              u = Math.sqrt(
                this.faceVX * this.faceVX + this.faceVY * this.faceVY
              );
            u > l && ((this.faceVX *= l / u), (this.faceVY *= l / u)),
  ...
  function (t, i, e) {
    ...
    function o(t) {
      var i = L.width,
        e = L.height;
      E = new d.L2DTargetPoint();
      var r = e / i,
        o = g.default.VIEW_LOGICAL_LEFT,
        s = g.default.VIEW_LOGICAL_RIGHT,
        _ = -r,
        a = r;
      (window.Live2D.captureFrame = !1),
        (M = new d.L2DViewMatrix()).setScreenRect(o, s, _, a),
        M.setMaxScreenRect(
          g.default.VIEW_LOGICAL_MAX_LEFT,
          g.default.VIEW_LOGICAL_MAX_RIGHT,
          g.default.VIEW_LOGICAL_MAX_BOTTOM,
          g.default.VIEW_LOGICAL_MAX_TOP
        ),
        M.setMaxScale(g.default.VIEW_MAX_SCALE),
        M.setMinScale(g.default.VIEW_MIN_SCALE),
        (A = new d.L2DMatrix44()).multScale(1, i / e),
        (I = new d.L2DMatrix44()).multTranslate(-i / 2, -e / 2),
        I.multScale(2 / i, -2 / i),
        (v = (function () {
          for (
        ...
        (function t() {
          !(function () {
            m.default.reset(),
              ...
              E.update(),
              P.setDrag(E.getX(), E.getY()),
              v.clear(v.COLOR_BUFFER_BIT),
              m.default.multMatrix(A.getArray()),
              m.default.multMatrix(M.getArray()),
              m.default.push();
            for (var t = 0; t < P.numModels(); t++) {
              var i = P.getModel(t);
              if (null == i) return;
              i.initialized && !i.updating && (i.update(), i.draw(v));
            }
            m.default.pop();
          })();
          var i =
    ...
    function s(t, i, e) {
      ...
      var _ = 360 - r(e.left - t.x, -1 * (e.top - t.y)),
        ...
        $ = r(e.left + e.width - t.x, -1 * (e.top + e.height - t.y)),
        l = n / o,
        u = {};
      if (s < h) {
        var p = e.top - t.y,
    ...
    function _(t) {
      ...
      var i = L.getBoundingClientRect(),
        ...
        n = u(o.x - i.left),
        _ = p(o.y - i.top);
      g.default.DEBUG_MOUSE_LOG, e, r, E.setPoint(n, _);
    }

    function a() {
      w && (w = !1), E.setPoint(0, 0);
    }

    function h() {
      g.default.DEBUG_LOG, sessionStorage.setItem("Sleepy", "1");
    }
      ...
      if ("mousewheel" == t.type);
        ...
        !(function (t) {
          ...
          var i = L.getBoundingClientRect(),
            ...
            n = u(o.x - i.left),
            _ = p(o.y - i.top);
          g.default.DEBUG_MOUSE_LOG, e, r, P.tapEvent(n, _);
        })(t);
        ...
        g.default.DEBUG_LOG, a();
        var i = sessionStorage.getItem("SleepyTimer");
        window.clearTimeout(i),
          (i = window.setTimeout(h, 5e4)),
      ...
      "touchstart" == t.type
        ...
        ? (function (t) {
            var i = L.getBoundingClientRect(),
              ...
              n = u(o.x - i.left),
              _ = p(o.y - i.top);
            g.default.DEBUG_MOUSE_LOG, w && (e, r, E.setPoint(n, _));
          })(i)
        : "touchend" == t.type && a();
    }

    function u(t) {
      var i = I.transformX(t);
      return M.invertTransformX(i);
    }

    function p(t) {
      var i = I.transformY(t);
    ...
    var d = e(0),
      ...
      m = r(e(3)),
      T = e(2),
      P = (window.navigator.platform.toLowerCase(), new y.default()),
      S = !1,
      v = null,
      L = null,
      E = null,
  ...
  function (t, i, e) {
    ...
    (function (t) {
      !(function () {
        ...
        function $(t) {
          Lt || it.prototype.constructor.call(this, t);
        }
        ...
        function j() {
          Lt || (i.prototype.constructor.call(this), (this._$zo = new V()));
        }
        ...
        (i._$0s = 1),
          ...
          (e.prototype.releaseShader = function () {
            for (var t = st.frameBuffers.length, i = 0; i < t; i++)
              this.gl.deleteFramebuffer(st.frameBuffers[i].framebuffer);
          ...
          (e.prototype.setupLayoutBounds = function (t) {
            ...
            for (var o = 0, n = 0; n < e.CHANNEL_COUNT; n++) {
              ...
              if (0 == s);
                ...
                ((l = this.clipContextList[o++]).layoutChannelNo = n),
                  (l.layoutBounds.x = 0),
                  (l.layoutBounds.y = 0),
          ...
          (s.prototype.updateParam = function (t, i) {
            if (i._$AT && !i._$9L) {
              ...
              (o =
                o *
                (0 == this._$dP ? 1 : _t._$r2((e - i._$bs) / this._$dP)) *
                (0 == this._$eo || i._$Do < 0
                  ? 1
                  : _t._$r2((i._$Do - e) / this._$eo))),
          ...
          (_.start = function (t) {
            var i = _._$fT[t];
            null == i && (((i = new a())._$r = t), (_._$fT[t] = i)),
          ...
          (u.prototype._$zP = function () {
            null == this._$vo && (this._$vo = new et()),
          ...
          (p.prototype.setup = function (t, i, e) {
            (this._$ks = this._$Yb()),
              this.p2._$xT(),
              3 == arguments.length &&
                ((this._$Fo = t),
          ...
          (p.prototype.addSrcParam = function (t, i, e, r) {
            var o = new d(t, i, e, r);
            this._$lL.push(o);
          }),
          (p.prototype.addTargetParam = function (t, i, e, r) {
            var o = new g(t, i, e, r);
            this._$qP.push(o);
          }),
        ...
        var Et = function () {};
        (Et._$ni = function (t, i, e, r, o, n, s, _, a) {
          var h = s * n - _ * o;
          if (0 == h) return null;
          var $,
            l = ((t - e) * n - (i - r) * o) / h;
          ...
          (S._$br = function (t, i, e, r) {
            ...
            if (3 == o) {
              ...
              return (
                (1 - (N = s[2])) *
                  ((1 - T) * (u + (p - u) * l) + T * (f + (c - f) * l)) +
                N * ((1 - T) * (d + (y - d) * l) + T * (g + (m - g) * l))
              );
            }
            if (4 == o) {
              var P = r[n[0]],
              ...
              return (
                (1 - B) *
                  ((1 - N) *
                    ...
                    N * ((1 - T) * (E + (M - E) * l) + T * (A + (I - A) * l))) +
                B *
                  ((1 - N) *
                    ((1 - T) * (w + (x - w) * l) + T * (O + (D - O) * l)) +
          ...
          (S._$Vr = function (t, i, e, r, o, n, s, _) {
            ...
            if (a <= 0) {
              ...
              var y = o[h[2]],
                ...
                v = R * m;
              for (f = 0; f < l; )
                (n[u] = T * p[f] + P * c[f] + S * y[f] + v * g[f]),
                  ++f,
                  (n[u + 1] = T * p[f] + P * c[f] + S * y[f] + v * g[f]),
                  ++f,
                  (u += _);
            } else if (3 == a) {
              var L = o[h[0]],
              ...
              for (
                var Et = 1 << a, Mt = new Float32Array(Et), At = 0;
                At < Et;
                At++
              ) {
                for (var It = At, wt = 1, xt = 0; xt < a; xt++)
                  (wt *= It % 2 == 0 ? 1 - $[xt] : $[xt]), (It /= 2);
                Mt[At] = wt;
              }
              ...
              for (f = 0; f < l; ) {
                var Rt = 0,
                  ...
                  Ft = f + 1;
                for (Dt = 0; Dt < Et; Dt++)
                  (Rt += Mt[Dt] * Ot[Dt][f]), (bt += Mt[Dt] * Ot[Dt][Ft]);
          ...
          (x.startsWith = function (t, i, e) {
            var r = i + e.length;
            if (r >= t.length) return !1;
            for (var o = i; o < r; o++)
              if (x.getChar(t, o) != e.charAt(o - i)) return !1;
            return !0;
          }),
          (x.getChar = function (t, i) {
            return String.fromCharCode(t.getUint8(i));
          }),
          (x.createString = function (t, i, e) {
            for (
          ...
          (O.prototype._$zr = function (t, i, e) {
            var r = 1 << e;
            B._$Qb;
            for (
          ...
          (O.prototype._$h2 = function (t, i, e) {
          ...
          (D.prototype.mult = function (t, i, e) {
            return null == i
              ? null
              : (this == i
          ...
          (D.prototype.mult_safe = function (t, i, e, r) {
            if (t == e) {
              var o = new Array(16);
          ...
          (D.prototype.mult_fast = function (t, i, e, r) {
            r
          ...
          (D.prototype.translate = function (t, i, e) {
            (this.m[12] =
          ...
          (D.prototype.scale = function (t, i, e) {
            (this.m[0] *= t),
              (this.m[4] *= i),
              (this.m[8] *= e),
              (this.m[1] *= t),
                  ...
                  if ("$" != n) {
                    if (
                      ...
                      if (_ >= 0) {
                        ...
                        (a._$I0 = F._$D2._$BL()), h > i._$yT && (i._$yT = h);
                      }
                    }
                  } else {
                    for (
          ...
          (G.prototype.update = function () {
            ...
            for (var t = this._$_2.length, i = 0; i < t; i++)
              this._$_2[i] != this._$vr[i] &&
                ((this._$Js[i] = G._$ZS), (this._$vr[i] = this._$_2[i]));
            ...
            for (i = 0; i < n; i++)
              (this._$Ws[i] = G._$V2), (this._$Vs[i] = G._$V2);
            (null == this._$Er || this._$Er.length < r) &&
              (this._$Er = new Int16Array(r));
            for (i = 0; i < r; i++) this._$Er[i] = G._$W0;
            ...
            for (var l = null, u = 0; u < r; ++u) {
              ...
              try {
                ...
                null == l && ((l = t), st._$sT(st._$H7));
              }
            }
            null != l && G._$_0 && _._$Rb(l),
              G._$e && _.dump("_$DL"),
              G._$e && _.start("_$eL");
            for (i = this._$Js.length - 1; i >= 0; i--) this._$Js[i] = G._$jr;
          ...
          (G.prototype._$UT = function (t, i) {
            var e = new Float32Array(i);
            return I._$jT(t, 0, e, 0, t.length), e;
          }),
          (G.prototype._$02 = function (t, i, e, r) {
          ...
          (G.prototype._$Zo = function (t, i) {
            this._$3S[t] = i;
          }),
          (G.prototype.setParamFloat = function (t, i) {
          ...
          (G.prototype.setPartsOpacity = function (t, i) {
            ...
            switch (this._$_L) {
              case STATE_CLOSING:
                (r = (e - this._$bb) / this._$Dr) >= 1 &&
                  ((r = 1), (this._$_L = Mt.STATE_CLOSED), (this._$bb = e)),
                  (i = 1 - r);
                break;
              case STATE_CLOSED:
                (r = (e - this._$bb) / this._$Cb) >= 1 &&
                  ((this._$_L = Mt.STATE_OPENING), (this._$bb = e)),
                  (i = 0);
                break;
              case STATE_OPENING:
                (r = (e - this._$bb) / this._$mr) >= 1 &&
                  ((r = 1),
                  (this._$_L = Mt.STATE_INTERVAL),
                  (this._$12 = this._$T2())),
                  (i = r);
                break;
              case STATE_INTERVAL:
                this._$12 < e &&
                  ((this._$_L = Mt.STATE_CLOSING), (this._$bb = e)),
                  (i = 1);
                break;
              case STATE_FIRST:
              default:
        ...
        var Mt = function () {};
        (Mt.STATE_FIRST = "STATE_FIRST"),
          (Mt.STATE_INTERVAL = "STATE_INTERVAL"),
          (Mt.STATE_CLOSING = "STATE_CLOSING"),
          (Mt.STATE_CLOSED = "STATE_CLOSED"),
          (Mt.STATE_OPENING = "STATE_OPENING"),
          (V.prototype = new E()),
          (V._$As = 32),
          (V._$Gr = !1),
          (V._$NT = null),
          ...
          (V._$cr = function (t, i) {
            return (
              null == t || t._$yL() < i.length
                ? ((t = V._$9r(2 * i.length)).put(i), t._$oT(0))
          ...
          (V._$mb = function (t, i) {
            return (
              null == t || t._$yL() < i.length
                ? ((t = V._$vb(2 * i.length)).put(i), t._$oT(0))
                : (t.clear(), t.put(i), t._$oT(0)),
              t
            );
          }),
          ...
          (V.prototype._$Uo = function (t, i, e, r, o, n, s, _) {
            if (!(n < 0.01)) {
              var a = this._$U2[t],
          ...
          (X.prototype.init = function (t) {
            var i = new z(this);
            return (i._$Yr = new T()), this._$32() && (i._$Wr = new T()), i;
          }),
          ...
          (X.prototype._$2b = function (t, i) {
            ...
            if ((e._$hS(!0), this._$32())) {
              ...
              if (
                (e._$8r == A._$ur && (e._$8r = t.getBaseDataIndex(r)),
                e._$8r < 0)
              )
                st._$so && _._$li("_$L _$0P _$G :: %s", r), e._$hS(!1);
              else {
                ...
                if (null != o) {
                  ...
                  o._$nb(t, n, s, s, 1, 0, 2),
                    ...
                    (e._$Wr._$qT = e._$Yr._$qT - $ * Pt._$NS);
          ...
          (X.prototype._$nb = function (t, i, e, r, o, n, s) {
            i._$GT();
            for (
              var _,
                a,
                ...
                l = Math.sin(Pt._$bS * $._$qT),
                u = Math.cos(Pt._$bS * $._$qT),
                p = h.getTotalScale(),
                f = $.reflectX ? -1 : 1,
                c = $.reflectY ? -1 : 1,
                d = u * p * f,
          ...
          (X.prototype._$Jr = function (t, i, e, r, o, n) {
            e._$GT();
            var s = X._$Lo;
            (X._$Lo[0] = r[0]), (X._$Lo[1] = r[1]), i._$nb(t, e, s, s, 1, 0, 2);
            for (var _ = X._$To, a = X._$Po, h = 1, $ = 0; $ < 10; $++) {
              if (
                ((a[0] = r[0] + h * o[0]),
                (a[1] = r[1] + h * o[1]),
          ...
          (j.prototype.setTexture = function (t, i) {
            null == this._$zo &&
          ...
          (q.prototype.updateParamExe = function (t, i, e, r) {
            for (
              var o = ((i - r._$z2) * this._$D0) / 1e3,
                n = 0 | o,
                s = o - n,
          ...
          (Q.prototype._$nb = function (t, i, e, r, o, n, s) {
            var _ = i,
              a = null != _._$hr ? _._$hr : _._$Cr;
            Q.transformPoints_sdk2(e, r, o, n, s, a, this._$o, this._$A);
          }),
          (Q.transformPoints_sdk2 = function (i, e, r, o, n, s, _, a) {
            for (
              var h,
                $,
                l,
              ...
              if (
                ...
                if (!m) {
                  ...
                  (p -= 0.5 * ((c = 0.5 * (M + I)) + (y = 0.5 * (M - I)))),
                    (f -= 0.5 * ((d = 0.5 * (A + w)) + (g = 0.5 * (A - w))));
                }
                if (-2 < v && v < 3 && -2 < L && L < 3)
                  if (v <= 0)
                    if (L <= 0) {
                ...
                else (e[T] = p + v * c + L * y), (e[T + 1] = f + v * d + L * g);
              } else
                (h = 2 * ((0 | P) + (0 | S) * (_ + 1))),
                  ($ = P - (0 | P)) + (l = S - (0 | S)) < 1
                    ? ((e[T] =
          ...
          (Q.prototype.transformPoints_sdk1 = function (t, i, e, r, o, n, s) {
            for (
              var _,
                a,
                h,
          ...
          (it._$L7 = function () {
            l._$27(), dt._$27(), R._$27(), $._$27();
          }),
          (it.prototype.toString = function () {
            return this.id;
          }),
          (et.prototype._$1s = function () {
            return this._$4S;
          }),
          ...
          (rt.prototype._$lP = function (t, i, e, r) {
          ...
          (rt.prototype.drawElements = function (t, i, e, r, o, n, s, a) {
            try {
              o != this._$Qo &&
              ...
              for (
                ...
                Et._$ni(F, C, O, D, R - O, b - D, -(b - D), R - O, g),
                  Et._$ni(w, x, E, M, A - E, I - M, -(I - M), A - E, m);
                var z = (m[0] - g[0]) / g[1],
                  H = Math.min(O, R, F),
                  W = Math.max(O, R, F),
                  j = Math.min(D, b, C),
                ...
                if (
                  ...
                  st.IGNORE_CLIP ||
                    rt.clip(u, y, n, Y, O, D, R, b, F, C, E, M, A, I, w, x),
          ...
          (rt.clip = function (t, i, e, r, o, n, s, _, a, h, $, l, u, p, f, c) {
            e > 0.02
              ? rt.expandClip(t, i, e, r, $, l, u, p, f, c)
              : rt.clipWithTransform(t, null, o, n, s, _, a, h);
          }),
          (rt.expandClip = function (t, i, e, r, o, n, s, _, a, h) {
            var $ = s - o,
              l = _ - n,
              u = a - o,
              p = h - n,
            ...
            return (
              null != i._$P2(N) &&
              (rt.clipWithTransform(t, N, E, M, A, I, w, x, O, D, F, C, R, b),
              !0)
            );
          }),
          (rt.clipWithTransform = function (t, i, e, r, o, n, s, a) {
          ...
          (st.setupProfile = function (t, i) {
            ...
            for (var e in (arguments.length < 2 && (i = !0), t)) st[e] = t[e];
          }),
          (st.init = function () {
          ...
          (ht.prototype._$B2 = function (t, i, e) {
            var r = i,
          ...
          (ht.prototype._$Nr = function (t, i) {
            var e = i;
            if (
              (e._$GT(),
              this._$GS._$Ur(t) &&
                (H.prototype._$Nr.call(this, t, e), !e._$IS[0]))
            ) {
              var r = ht._$gT;
              (r[0] = !1),
                S._$Vr(
          ...
          (ht.prototype._$2b = function (t, i) {
            try {
              i._$GT();
              var e = !1;
              i._$IS[0] && (e = !0);
              var r = i;
              if (!e && (H.prototype._$2b.call(this, t), this._$32())) {
          ...
          (ht.prototype.draw = function (t, i, e) {
            if ((e._$GT(), !e._$IS[0])) {
              var r = e,
                o = this._$LP;
              o < 0 && (o = 1);
          ...
          (ut.prototype.setTexture = function (t, i) {
          ...
          (pt.prototype._$e = function () {
            for (var t = 0; t < this.motions.length; t++) this.motions[t]._$w0;
          }),
          (ft._$Gs = 0),
          ...
          (ct.prototype._$PS = function (t, i, e) {
          ...
          (ct.prototype.transform = function (t, i, e) {
            null == e && (e = new Array(0, 0));
            var r = this.m;
            return (
              (e[0] = r[0] * t + r[3] * i + r[6]),
          ...
          (ct.prototype.translate = function (t, i) {
            var e = this.m;
            (e[6] = e[0] * t + e[3] * i + e[6]),
              (e[7] = e[1] * t + e[4] * i + e[7]),
              (e[8] = e[2] * t + e[5] * i + e[8]);
          }),
          (ct.prototype.scale = function (t, i) {
            var e = this.m;
            (e[0] *= t),
              (e[1] *= t),
              (e[2] *= t),
          ...
          (ct.prototype.shear = function (t, i) {
            var e = this.m,
              r = e[0] + e[3] * i,
              o = e[1] + e[4] * i,
              n = e[2] + e[5] * i;
          ...
          (dt.getID = function (t) {
            var i = dt._$tP[t];
            return null == i && ((i = new dt(t)), (dt._$tP[t] = i)), i;
          }),
          ...
          (yt._$cr = function (t, i) {
            return (
              null == t || t._$yL() < i.length
                ? ((t = yt._$9r(2 * i.length)).put(i), t._$oT(0))
                : (t.clear(), t.put(i), t._$oT(0)),
              t
            );
          }),
          (yt._$mb = function (t, i) {
            return (
              null == t || t._$yL() < i.length
                ? ((t = yt._$vb(2 * i.length)).put(i), t._$oT(0))
                : (t.clear(), t.put(i), t._$oT(0)),
              t
            );
          }),
          ...
          (yt.prototype._$Uo = function (t, i, e, r, o, n, s, _) {
            if (!(n < 0.01 && null == this.clipBufPre_clipContextMask)) {
              ...
              if (null != this.clipBufPre_clipContextMask) {
                a.frontFace(a.CCW),
                  ...
                  (this._$vS = gt(a, this._$vS, r)),
                  (this._$no = mt(a, this._$no, e)),
                ...
                var y = this.getClipBufPre_clipContextMask().layoutChannelNo,
                  g = this.getChannelFlagAsColor(y);
                a.uniform4f(this.u_channelFlag, g.r, g.g, g.b, g.a);
                ...
                (y = this.getClipBufPre_clipContextDraw().layoutChannelNo),
                  (g = this.getChannelFlagAsColor(y));
                a.uniform4f(this.u_channelFlag_Loc_Off, g.r, g.g, g.b, g.a),
          ...
          (yt.prototype.setTexture = function (t, i) {
            this.textures[t] = i;
          }),
          ...
          (yt.prototype.compileShader = function (t, i) {
            var e = this.gl,
              r = i,
              o = e.createShader(t);
  ...
  function (t, i, e) {
    ...
    (o.prototype.createModel = function () {
      ...
      (o.prototype.tapEvent = function (t, i) {
        a.default.DEBUG_LOG;
        for (var e = 0; e < this.models.length; e++)
          this.models[e].hitTest(a.default.HIT_AREA_HEAD, t, i)
            ? (a.default.DEBUG_LOG, this.models[e].setRandomExpression())
            : this.models[e].hitTest(a.default.HIT_AREA_BODY, t, i)
            ? (a.default.DEBUG_LOG,
  ...
  function (t, i, e) {
    ...
    (o.prototype = new n.L2DBaseModel()),
              ...
              r.loadTexture(i, o, function () {
                if (r.isTexLoaded) {
                  ...
                  if (null != r.modelSetting.getHitAreasCustom()) {
                    ...
                    null != s.head_x &&
                      (_.default.hit_areas_custom_head_x = s.head_x),
                      null != s.head_y &&
                        (_.default.hit_areas_custom_head_y = s.head_y),
                      null != s.body_x &&
                        (_.default.hit_areas_custom_body_x = s.body_x),
                      null != s.body_y &&
                        (_.default.hit_areas_custom_body_y = s.body_y);
                  }
      ...
      (o.prototype.startMotion = function (t, i, e) {
        ...
        if (null != r && "" != r) {
          if (e == _.default.PRIORITY_FORCE)
            ...
            return void _.default.DEBUG_LOG;
          var o,
            n = this;
          null == this.motions[t]
      ...
      (o.prototype.setExpression = function (t) {
        ...
        _.default.DEBUG_LOG, this.expressionManager.startMotion(i, !1);
      }),
